...
SoilLayer::SoilLayer() :
	...
	sl_thickness(0.0),
	sl_vs(0.0), sl_vp(0.0),
	sl_rho(0.0), sl_hG(1.0), sl_m(1.0), sl_h0(1.0), sl_chi(0.0), sl_IO(false)
{

}


SoilLayer::SoilLayer(std::string name, double thickness, double vs, double vp, double rho, double Su, double hG, double m, double h0, double chi, bool IO) :
	sl_name(name),
	sl_thickness(thickness),
	sl_vs(vs), sl_vp(vp), sl_su(Su),
	sl_rho(rho), sl_hG(hG), sl_m(m), sl_h0(h0), sl_chi(chi), sl_IO(IO)
{
